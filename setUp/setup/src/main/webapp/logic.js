        ...
        <div class="col-md-4">
            <div class="card h-100" style="width: 18rem;">
                ...
                <div class="card-body">
                   ...
                   <button type="button" class="btn btn-primary" onclick="modalClickHandle()" style="font-size: 14px;" >Add Review</button>
                </div>
            </div>
        </div>`;
    }
...
function modalClickHandle(){
    console.log("inside Function ")
    jQuery.noConflict();
    jQuery('#addReviewModal').modal('toggle')
}
